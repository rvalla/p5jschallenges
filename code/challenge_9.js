...
Como estas variables están afuera de las funciones la
...
/*
DESAFÍO 9
Este programa dibuja líneas a lo ancho y alto de la pantalla. ¡Y se cruzan! Tienen que modificar
la función mousePressed() para que cada vez que hagan click en la pantalla las líneas sean más grandes.
También pueden hacer que el color cambie cuando tocan la letra "c" editando la función keyPressed().
*/
